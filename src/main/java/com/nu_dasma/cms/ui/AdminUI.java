...
public class AdminUI implements BaseUI {
    ...
    @Override
    public void help() {
        System.out.println("\033[32mOn\033[0m: CMS Admin CLI");
    ...
    public void run(Scanner scanner) {
        System.out.println("Logged in as \033[32mAdmin\033[0m.");
        this.help();
    ...
    public void dispose() {
        synchronized (AdminUI.class) {
            AdminUI.instance = null;
        }
    }

    public static AdminUI getInstance() {
        if (AdminUI.instance != null) {
            return AdminUI.instance;
        }

        synchronized (AdminUI.class) {
            AdminUI.instance = new AdminUI();
        }
